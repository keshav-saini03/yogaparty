...
| 7   | Duplicate phone: stays on /signup, verbatim error, no second row | inline alert text matches verbatim, exactly 1 row in DB                                | url=/signup, error=`This number is already in! Check your messages — you're already tuned in.`, rows=1 | PASS    |
